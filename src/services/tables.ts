...
async function fetchTables() {
	try {
		const response = await axios.get(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables`);
...
async function fetchTablesActive() {
	try {
		const response = await axios.get(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?active`);
		return response.data;
	} catch (err) {
		console.log(err);
	}
...
async function fetchTablesActiveCall() {
	try {
		const response = await axios.get(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?activeCall `);
		return response.data;
	} catch (err) {
		console.log(err);
	}
...
async function fetchTableActiveCall(tableID: string) {
	try {
		const response = await await fetch(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?searchTableCall=${tableID}`,
			{ cache: 'no-store' });
...
async function fetchTable(tableID: string) {
	try {
		const response = await axios.get(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?searchTable=${tableID}`);
...
async function updateTableNumberDesactive(tableID: string) {
	try {
		const response = await axios.put(
			/*or get*/ `https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables/?desactivate=${tableID}`
		);
		return response.data;
	} catch (err) {
		console.log(err);
...
async function updateTableNumberCall(tableID: string) {
	try {
		const response = await axios.put(
			/*or get*/ `https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables/?call=${tableID}`
		);
		return response.data;
	} catch (err) {
		console.log(err);
...
async function updateTableNumberActive(tableID: string) {
	try {
		const response = await axios.put(
			/*or get*/ `https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables/?activate=${tableID}`
		);
		return response.data;
	} catch (err) {
		console.log(err);
...
async function peopleInTableFetch(tableID: string) {
	try {
		const response = await axios.get(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables/?peopleInTableSearch=${tableID}`);
		return response.data;
	} catch (err) {
		console.log(err);
	}
...
async function fetchOrderItem() {
	try {
		const response = await axios.get(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?itemPeopleInTableJoin`);
		return response.data;
...
async function peopleInTable(idPeopleInTable: string, tableId: string) {
	try {
		const response = await axios.post(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables/${idPeopleInTable}/${tableId}?peopleInTable`);
		return response.data;
	} catch (err) {
		console.log(err);
	}
...
async function itemPeopleInTable(body: ItemPeopleInTable) {
	try {
		const response = await axios.post(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?itemPeopleInTable`, body);
		return response;
	} catch (err) {
		console.log(err);
	}
...
async function deleteOrder(orderID: string) {
	try {
		const response = await axios.delete(`https://cwg24mdbt9.execute-api.us-east-1.amazonaws.com/dev/tables?deleteOrder=${orderID}`);
		return response;
	} catch (err) {
		console.log(err);
	}
